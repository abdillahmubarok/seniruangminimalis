...
const HeroSection = () => {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    // Membuat pesan WhatsApp yang lebih sederhana dan menghindari terlalu banyak format khusus
    // Perhatikan: Menghindari simbol-simbol yang mungkin menimbulkan masalah encoding
...
Terkirim melalui: Website Ikmal Plafon`
    ...
    // Gunakan metode alternatif dengan format URL WhatsApp yang berbeda
    // Format api.whatsapp.com kadang lebih stabil daripada wa.me untuk beberapa perangkat
    const encodedMessage = encodeURIComponent(message)
    const whatsappUrl = `https://api.whatsapp.com/send?phone=${whatsappNumber}&text=${encodedMessage}`
    
    // Log untuk debugging (opsional, dapat dihapus di produksi)
    console.log("URL WhatsApp:", whatsappUrl)
    
    // Coba menggunakan location.href alih-alih window.open untuk kompatibilitas yang lebih baik
