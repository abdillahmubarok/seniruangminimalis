    ...
    <footer className="bg-primary text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary border-2 border-amber-400 bg-opacity-10 flex items-center justify-center hover:bg-secondary transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z" />
                </svg>
              </a>
              <a href="https://instagram.com/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-primary border-2 border-amber-400 bg-opacity-10 flex items-center justify-center hover:bg-secondary transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <svg className="h-5 w-5 mt-1 mr-3 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                </svg>
                <span>
                  <a href="https://maps.app.goo.gl/tUJiU7x9rkmbF2L3A" className="hover:text-amber-400 transition-colors">
                    Desa Jetak Lengkong, Dukuh Blumbang, RT04/ RW02 Kec. Wonopringgo 51181 Pekalongan Jawa Tengah - Indonesia
                  </a>
                </span>
              </li>
        ...
        <div className="mt-10 text-center relative">
          ...
          <div className="relative inline-block bg-primary px-4 py-2 text-xs text-gray-400 group transition-all duration-300 hover:text-white">
